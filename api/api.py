...
class ResponseResource(ModelResource):
	...
	multi_select = fields.ToManyField('api.api.MultiSelectResponseResource', 'multi_select')
	body_location = fields.ToManyField('api.api.BodyLocationResponseResource', 'body_location')
